...
Copy the config from `tk-spikes/install/items/items.md` to `QBCore/Shared/items.lua`

Copy the images from `tk-spikes/install/images` to your inventory resource.
